<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddNewProduct.aspx.cs" Inherits="ShoppingHeart.Admin.AddEditCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td class="style7" colspan="2" 
            ...
            <strong>Add New Product</strong><hr /></td>
    </tr>
    <tr>
